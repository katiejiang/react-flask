...
class Config:
    ...
    """
    APP_NAME = os.environ.get('APP_NAME') or 'Flask Base API'
    CSRF_ENABLED = True
    ...
    if os.environ.get('SECRET_KEY'):
        ...
        print('SECRET_KEY environment variable not set. SHOULD NOT SEE IN PRODUCTION.')
    ...
    ADMIN_EMAIL = os.environ.get('ADMIN_EMAIL') or 'admin@flaskbaseapi.com'
...
class DevelopmentConfig(Config):
    ...
    def init_app(cls, app):
        print('This app is in development mode. YOU SHOULD NOT SEE THIS IN PRODUCTION.')
